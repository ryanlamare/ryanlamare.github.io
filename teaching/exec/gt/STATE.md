...
- **The close (11 Sep).** After the lesson: a write-in wall, "Information asymmetries in your world" (room `m8-yourworld`, sorted aloud into signal / jam / screen), then Top of the class, then "Eight modules, eight ideas" as the last slide of the programme.
- **Not yet decided.** Programme-wide honours beyond the Hidden Agenda three (what to award, physical prizes or not). Settled 11 Sep: one round only, no reserve; the bidders stay exactly even and nothing is needed from JN and BJ for the cards; the module one wall is cut from m8, the game stands alone.
