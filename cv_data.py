...
PUB_GROUPS = [
  ...
  ("Journal Articles", [
    dict(y="2026", authors=["J. Ryan Lamare", "Margaret Huizinga", "Jeffrey Thomas"], t="Punching Upward and Outward: The Mitigating Effects of Employment Conditions on Democratic Discontent", u=None, venue_cv="<i>ILR Review</i> (conditionally accepted).", venue_home=None, icon="ic-ballot", featured=True),
