...
PUB_GROUPS = [
  ...
  ("Journal Articles", [
    dict(y="2026", authors=["J. Ryan Lamare", "Margaret M. Huizinga", "Jeffrey P. Thomas"], t="Punching Upward and Outward: The Mitigating Effects of Employment Conditions on Democratic Discontent", u=None, venue_cv="<i>ILR Review</i> (forthcoming).", venue_home=None, icon="ic-ballot", featured=True),
