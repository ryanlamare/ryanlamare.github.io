...
PUB_GROUPS = [
  ...
  ("Journal Articles", [
    dict(y="2026", authors=["J. Ryan Lamare", "Margaret M. Huizinga", "Jeffrey P. Thomas"], t="Punching Upward and Outward: The Mitigating Effects of Employment Conditions on Democratic Discontent", u=None, venue_cv="<i>ILR Review</i> (forthcoming).", venue_home=None, icon="ic-ballot", featured=True, replication="https://doi.org/10.5281/zenodo.22049135"),
  ...
  ("Working Papers", [
    dict(raw="Cherise Regier, J. Ryan Lamare, and Faraz Shahidi. “Employee Voice and Workplace Wellbeing in the Age of AI: Cross-National Empirical Evidence.”", y="", u=None),
...
BLOCKS = [
  ...
  ["row", "2024–", "Professor of Employment Relations and Human Resource Management", None],
  ...
  ["row", "2008", "PhD, Industrial and Labor Relations", None],
  ["row", "2005", "MS, Industrial and Labor Relations", None],
  ["row", "2004", "BS, Industrial and Labor Relations", None],
  ...
  ["h2", "Keynote &amp; Invited Talks", ""],
  ["row", "2024", "“Industrial Relations Research in the Era of Crises: Rethinking How Unions and Politics Interact.” Keynote address, BUIRA", None],
  ...
  ["row", "2014", "“The Strategic Underpinnings of Conflict Management in U.S. Corporations.” University of Sheffield; Pennsylvania State University", None],
  ...
  ["row", "", "Introduction to Employment Relations · Seminar in Employment Relations · Workplace Dispute Resolution", None],
  ...
  ["h3", "Administrative Roles — London School of Economics", None],
  ["row", "", "Faculty Group Lead, Employment Relations and Human Resource Management (2024–); PhD Programme Director (2024–)", None],
  ...
  ["row", "", "Chair (current): Margaret Huizinga", None],
  ["h3", "Committees — London School of Economics", None],
  ["row", "", "Promotions Committee (2026–); ER/HR Search Committee (2023–2024); Macro OB Search Committee (2024)", None],
